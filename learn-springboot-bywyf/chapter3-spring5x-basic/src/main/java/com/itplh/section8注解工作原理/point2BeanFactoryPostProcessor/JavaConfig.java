 ...
 */
@Configuration("com.itplh.section8注解工作原理.point2BeanFactoryPostProcessor.JavaConfig")
public class JavaConfig {

    // 因为CustomBeanService是自定义的Bean，所以IDEA的检测会显示红色，但可以正常执行
    @Bean("com.itplh.section8注解工作原理.point2BeanFactoryPostProcessor.JavaConfig.commandLineRunner")
